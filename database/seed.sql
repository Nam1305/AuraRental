...
('70000000-0000-0000-0000-000000000008', 'RSV-HN-MOCK-CONFIRMED', '30000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'CONVERTED_TO_ORDER', now() + interval '3 days', now() + interval '4 days', 'FULL', 4500000, now() - interval '1 day', null, null, null, now() - interval '1 day', null, '20000000-0000-0000-0000-000000000002', now() - interval '2 days'),
('70000000-0000-0000-0000-000000000009', 'RSV-HN-MOCK-VERIFY-ID', '30000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000001', 'CONVERTED_TO_ORDER', now() + interval '4 days', now() + interval '5 days', 'FIFTY_WITH_ID', 1600000, now() - interval '1 day', null, null, null, now() - interval '1 day', null, '20000000-0000-0000-0000-000000000002', now() - interval '2 days'),
('70000000-0000-0000-0000-000000000010', 'RSV-HN-MOCK-TO-INSPECT', '30000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000001', 'CONVERTED_TO_ORDER', now() - interval '3 days', now() - interval '2 days', 'FULL', 5200000, now() - interval '5 days', null, null, null, now() - interval '5 days', null, '20000000-0000-0000-0000-000000000002', now() - interval '6 days'),
('70000000-0000-0000-0000-000000000011', 'RSV-SG-MOCK-ACTIVE', '30000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000002', 'ACTIVE', now() + interval '3 days', now() + interval '4 days', 'FULL', 4500000, now() + interval '6 hours', null, null, null, null, null, '20000000-0000-0000-0000-000000000003', now() - interval '30 minutes')
